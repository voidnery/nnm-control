...
// WMSPanel account objects: ABR ladders, application aliases, origin apps.
//
// They used to sit on the Distribution page, and did not belong there.
// Building a delivery network is "which servers, which channels, what link";
// these are account-wide settings applied to whatever servers are ticked, and
// an operator building a network has no reason to walk past them. Mixing them
// in made the page read as eight equally important things and buried the two
// questions that actually get asked: what am I delivering, and does it work.
//
// They are still used, and the delivery pages still read them — the "HTTP
// Origin disables this edge's cache" finding comes from exactly this data.
// What changed is who has to look at it.
...
export default function AccountObjectsPage() {
  ...
  return (
    <div>
      <h1>{t('page.objects.title')}</h1>
      <div className="sub">{t('page.objects.sub')}</div>
